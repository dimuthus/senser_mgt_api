...
class getSecrets_VaultService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('F:\\sensor_monitor_api/config/secrets/'.$container->getEnv('string:default:kernel.environment:APP_RUNTIME_ENV'), \Symfony\Component\String\LazyString::fromCallable(\Closure::fromCallable([0 => $container, 1 => 'getEnv']), 'base64:default::SYMFONY_DECRYPTION_SECRET'));
    }
}
